...
public class PanelVenta extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Cliente: "+venta.getUsuario().getNick()+". Fecha de la compra: "+venta.getFecha()+". Costo: "+String.valueOf(venta.getPrecioTotal()));
